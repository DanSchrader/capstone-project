...
import tutorialImage12 from '../../images/rtm-wallet-download.png';
...
export default function MiningPools() {
  return (
    <TutorialArticleItem>
      ...
      <MiningTutorialText
        text={
          'Jetzt ist es an der Zeit, uns für einen Mining-Pool zu entscheiden. Auf der Seite miningpoolstats.stream/raptoreum werden wir fündig. An dieser Stelle sei auch gleich auf eine Problematik bzgl. Raptoreum verwiesen:'
        }
      />
      <MiningTutorialText
        text={
